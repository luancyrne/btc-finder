...
async function menu() {
    let [min, max, key] = await escolherCarteira(`Escolha uma carteira puzzle( ${1} - ${11}): `)
    const answer = await fazerPergunta(`Escolha uma opcao (${1} - Comecar do inicio, ${2} - Escolher uma porcentagem, ${3} - Escolher minimo): `)
